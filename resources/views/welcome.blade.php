                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="{{route('admin.dashboard')}}">
                        ...
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="{{asset('backend/assets/images/logo.png')}}" alt="homepage" class="light-logo" width="120px" />
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-left mr-auto">
                        ...
                        <li class="nav-item search-box"> <a class="nav-link waves-effect waves-dark" href="javascript:void(0)"><i class="ti-search"></i></a>
                           ...
                           <p style="margin-top: 10px;margin-left: 142px;font-size: 25px;color: #fff">এস ট্রেডাস্</p>
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <a class="dropdown-item" href="{{route('admin.change')}}"><i class="ti-settings m-r-5 m-l-5"></i> Account Setting</a>
                                <div class="dropdown-divider"></div>
        ...
        <div class="page-wrapper">
         @yield('content')
            ...
            <footer class="footer text-center">
                All Rights Reserved by SATT IT. Designed and Developed by <a href="https://sattit.com">SATT IT</a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
