...
<div class="row" style="max-width: 98%;margin: auto;padding: 5px;border: 2px solid #555555">
  <div class="col-md-12">
    <div class="card">
    <form action="{{route('admin.sell.regstore')}}" method="post">
      {{@csrf_field()}}
...
$cus =DB::table('buyers')->get();
        ...
        <div class="col-md-5" style="padding-top: 15px">
            <label>date </label>
            <div class="form-group">
             <input type="text" name="date" class="form-control" id="datepicker-autoclose" placeholder="mm/dd/yyyy">
            </div>
        </div>
...
var tr =$("#invoice_items").parent().parent();
console.log(tr);
tr.find("#sell").html(data);
 ...
 function addNewRow()
{
  ...
  dateType: 'text',
  data:{getNewOrderItem:1,'cust_name':cust_name},
  success:function(data)
  { 
